...
-- ESCENA
centr :: Point3D
centr = Point3D (-8) (-10) (-7)
-- centr' :: Point3D
centr' = Point3D (8.5) (-9) (-8)
-- centr'' :: Point3D
-- centr'' = Point3D 0 (-15) (-44)
-- centr''' :: Point3D
-- centr''' = Point3D 15 (-10) (-22)
luz :: Luz
luz = Luz (Point3D (0) 12 (-6)) (RGB 255 255 255) 1.2 -- Dentro
luz' :: Luz
...
plano0 :: Shape
plano0 = Plane (Plano (Point3D (-15) 0 0) (Direction 1 0 0) (RGB 255 10 10) (0.9,0,0) 0 0) --Izq
plano1 :: Shape
plano1 =  Plane (Plano (Point3D 15 0 0) (Direction 1 0 0) (RGB 10 255 10) (0.9,0,0) 0 0) -- Der
plano2 :: Shape
plano2 =  Plane (Plano (Point3D 0 15 0) (Direction 0 1 0) (RGB 100 100 100) (0.9,0,0) 0 0) -- Techo
plano3 :: Shape
plano3 =  Plane (Plano (Point3D 0 0 (-15)) (Direction 0 0 (-1)) (RGB 100 100 100) (0.9,0,0) 0 0) -- Fondo
-- plano4 :: Shape
plano4 =  Plane (Plano (Point3D 0 (-15) 0) (Direction 0 1 0) (RGB 100 100 100) (0.9,0,0) 1.6 0) -- Suelo
plano5 :: Shape
...
-- rect0 :: Shape
rect0 = Rectangle (Rectangulo (Point3D 15 0 (-10)) (Direction (1) 0 0) (Direction 0 0 (-1)) 30 30 (RGB 10 255 10) (0.9,0,0) 0 0) -- Der
-- rect1 :: Shape
rect1 = Rectangle (Rectangulo (Point3D (-15) 0 (-10)) (Direction 1 0 0) (Direction 0 0 1) 30 30 (RGB 255 10 10) (0.9,0,0) 0 0) -- Izq
-- rect2 :: Shape
rect2 = Rectangle (Rectangulo (Point3D 0 0 (-15)) (Direction 0 0 (1)) (Direction (-1) 0 0) 30 30 (RGB 100 100 100) (0.9,0,0) 0 0) -- Fondo
-- rect3 :: Shape
rect3 = Rectangle (Rectangulo (Point3D 0 15 (-0)) (Direction 0 (-1) 0) (Direction (-1) 0 0) 40 40  (RGB 100 100 100) (0.9,0,0) 0 0)--Techo
